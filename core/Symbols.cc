...
SymbolRef::SymbolRef(const GlobalState &from, SymbolRef::Kind kind, u4 _id) : _id((_id << 3) | (u4)kind) {}
SymbolRef::SymbolRef(GlobalState const *from, SymbolRef::Kind kind, u4 _id) : _id((_id << 3) | (u4)kind) {}
