...
public:
    ...
    static SymbolRef Magic_undeclaredFieldStub() {
        return SymbolRef(nullptr, SymbolRef::Kind::Field, 1);
    }

    static constexpr int MAX_PROC_ARITY = 10;
    static SymbolRef Proc0() {
        return SymbolRef(nullptr, SymbolRef::Kind::ClassOrModule, MAX_SYNTHETIC_CLASS_SYMBOLS - MAX_PROC_ARITY * 3 - 3);
    }
    ...
    static SymbolRef Proc(int argc) {
        ...
        return SymbolRef(nullptr, SymbolRef::Kind::ClassOrModule, Proc0().id() + argc * 3);
    }
    ...
    static SymbolRef last_synthetic_class_sym() {
        ENFORCE(last_proc().id() == MAX_SYNTHETIC_CLASS_SYMBOLS - 3);
